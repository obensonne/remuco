...
#define REM_PS_PBS_ERROR	(REM_PBS_COUNT + 0)
#define REM_PS_PBS_SRVOFF	(REM_PBS_COUNT + 1)
 ...
 * 
 * @see rem_player_status_fp_update()
 */
typedef enum {
	/** No difference. */
	REM_PS_DIFF_NONE = 0,
	/** @a pbs, @a volume, @a repeat, @a shuffle and/or @a cap_pos differs. */
