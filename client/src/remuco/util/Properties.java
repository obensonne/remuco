 ...
 * <p>
 * <p>
 * The {@link #loadFromXML(InputStream)} and {@link #storeToXML(OutputStream,
 * String, String)} methods load and store properties in a simple XML format. By
 * default the UTF-8 character encoding is used, however a specific encoding may
 * be specified if required. An XML properties document has the following
 * DOCTYPE declaration:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * Note that the system URI (http://java.sun.com/dtd/properties.dtd) is <i>not</i>
...
public class Properties extends Hashtable {
	...
	private static void writeln(OutputStreamWriter osw, String s)
			throws IOException {
		osw.write(s);
		osw.write("\n");
	}
	 ...
	 * the <tt>Hashtable</tt> call to <code>put</code>.
	 * 
	 * @param key
	...
	public synchronized void store(OutputStream out, String comments)
		...
		awriter = new OutputStreamWriter(out, "8859_1");
		if (comments != null)
