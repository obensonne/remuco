...
public final class Keys {
	...
	public static final int ACTION_PLAYPAUSE = 0, ACTION_STOP = 1,
			...
			ACTION_RATEDOWN = 8, ACTION_EDITTAGS = 9, ACTION_PLAYLIST = 10,
			ACTION_IMAGE = 11, ACTION_COUNT = 13;
	 ...
	 * @deprecated
	 */
	public static final int ACTION_LIBRARY = 12;
	...
	public static final String[] actionNames = new String[] { "Play/Pause",
			...
			"Volume mute", "Rate up", "Rate down", "Edit Tags",
			"Show playlist", "Show image", "Show Library" };
	...
	private static final int[] config = new int[] { Canvas.KEY_NUM5, 0,
			...
			Canvas.KEY_NUM3, Canvas.KEY_NUM7, Canvas.KEY_NUM0, Canvas.KEY_NUM9 };
