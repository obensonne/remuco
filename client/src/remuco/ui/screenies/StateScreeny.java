...
public class StateScreeny extends Screeny {
	...
	public StateScreeny(Theme theme, IPlayerInfo player) {

		super(theme, player);

		screenyPlayback = new SimpleScreeny(theme, player,
				SimpleScreeny.TYPE_PLAYBACK);
		screenyRepeat = new SimpleScreeny(theme, player,
				SimpleScreeny.TYPE_REPEAT);
		screenyShuffle = new SimpleScreeny(theme, player,
				SimpleScreeny.TYPE_SHUFFLE);

		screenyVolume = new SliderScreeny(theme, player);
