...
public final class KeyConfigScreen extends List implements CommandListener,
	...
	public KeyConfigScreen(final CommandListener parent, final Display display) {
		...
		alertKeyConflict.addCommand(UI.CMD_NO);
		alertKeyConflict.addCommand(UI.CMD_YES);
		...
		alertReset.addCommand(UI.CMD_NO);
		alertReset.addCommand(UI.CMD_YES);
	...
	public void commandAction(Command c, Displayable d) {
		...
		} else if (c == UI.CMD_YES && d == alertReset) {
		...
		} else if (c == UI.CMD_NO && d == alertReset) {
		...
		} else if (c == UI.CMD_NO && d == alertKeyConflict) {
