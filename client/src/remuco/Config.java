...
public final class Config {
	...
	private static final String KEY_ENC = "encoding";
	...
	public static String encoding = Tools.getDefaultEncoding();
	...
	public static boolean load() {
		...
		if (enc != null) {
			try {
				...
				Log.ln("[CONF] stored encoding " + enc + " not supported");
				set(Config.KEY_ENC, encoding);
			}
		}

		Log.ln("[CONF] using encoding " + encoding);
	 ...
	 * {@link #devicesFromOptions()}. This means a non-<code>null</code>
	 * device name of length zero will be interpreted later by
